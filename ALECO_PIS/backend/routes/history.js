  ...
  return `
      SELECT
        ...
        ${C(`CASE
          ...
          WHEN l.action = 'group_add' THEN 'Ticket added to group'
          WHEN l.action = 'group_edit' THEN 'Group details updated'
          WHEN l.action = 'group_ungroup' THEN 'Ticket ungrouped'
