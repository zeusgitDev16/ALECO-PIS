/**
 * Word-boundary matching for urgent ticket keywords (same semantics as legacy frontend).
 * Escapes regex metacharacters per whitespace-separated token.
 */
 ...
 * @param {string[]} keywords - non-empty trimmed phrases
 * @returns {boolean}
 */
