    ...
    return (
        <div id="report" className="report-problem-container">
            ...
            <div className="report-main-card">
                <div className="report-content-wrapper" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'stretch' }}>
                    ...
                    <div className="report-details-column" style={{ display: 'flex', flexDirection: 'column' }}>
                        <div className="concern-group" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className="report-upload-column" style={{ display: 'flex', flexDirection: 'column' }}>
                        <div className="modal" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                           <div className="modal-header">
                            ...
                            <div className="modal-body" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                                ...
                                <button className="upload-area" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: 'auto' }}>
