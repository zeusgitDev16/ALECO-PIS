...
const UrgentTickets = ({ tickets, isLoading, onSelectTicket, selectedIds, onToggleSelect }) => {
        ...
        return (
            <div className="urgent-tickets-wrapper">
                <div className="urgent-section-header">
                    ...
                    <h3 className="urgent-title">Action Required: Urgent Tickets (<Skeleton width={30} height={20} inline />)</h3>
                </div>
                <div className="ticket-grid-wrapper urgent-grid">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="ticket-card-container urgent-card skeleton-loading">
                            ...
                            <div className="card-footer-metadata">
                                ...
                                <span className="status-pill-solid urgent"><Skeleton width={80} height={20} /></span>
                            </div>
                        </div>
                    ))}
                </div>
