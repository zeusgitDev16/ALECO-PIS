...
export function getPosterFooterContact() {
  ...
  return {
    disclaimer:
      ...
      'Power Service will be restored upon completion of work without prior notice.',
    disclaimerBold:
      env.VITE_POSTER_DISCLAIMER_BOLD ||
      'PLEASE CONSIDER OUR DISTRIBUTION LINES ALWAYS ENERGIZED.',
    facebook: env.VITE_POSTER_FOOTER_FB || 'facebook.com/albayelectric',
    ...
    logoUrl: env.VITE_POSTER_LOGO_URL || '',
  };
}
